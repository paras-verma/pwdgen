...
<li
	class="flex items-center gap-[9px] py-[10px] border-b border-b-border-soft transition-[background,box-shadow] duration-200 ease-out last:border-b-0 {isLastCopied ? 'bg-accent-dim rounded-[6px] px-[6px] mx-[-6px] shadow-[inset_-3px_0_0_var(--accent)]' : ''}"
>
